...
create table FundCompanyTradeHisItem(
date varchar(20) comment '时间',
fund_company_name varchar(255) comment '基金名称',
stock_name varchar(255) comment '股票名称',
purchases varchar(255) comment '买入额',
sell varchar(255) comment '卖出额',
net_amount varchar(255) comment '买卖净额',
price_change_rate varchar(255) comment '涨跌幅',
reason varchar(255) comment '入榜原因'
block_name varchar(255) comment '所属板块',
);